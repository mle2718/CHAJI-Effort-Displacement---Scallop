...
Here is a short description of the wind energy areas and how they will close (or not close) area to fishing.  How close will fishing be able to occur within Wind Lease Areas / Turbines?
...
1.  Observer cover a subset of the fishery. According to the 2021 SBRM report, it was approximately 8-10% of effort for the Limited access fleet. This would provide haul level lat-lon and estimates of catch for the sampled subset. We viewed the subset as too limited - it would provide us with observations of approximately 200 Access area and 100 open area trips per year.

2. VMS - VMS data would provide lat-lon at a high frequency. Other researchers have used this; however we uncomfortable with figuring out how to allocate catch along the VMS track.
...
And we have supplemented this with some extra information.
...
ACTIVITY_CODE and a set of PLAN_CAT categorica variables are used from the live DMIS tables. We join using TRIP_ID, DOCID.  See [here](/external_documentation/vms_declaration_code_glossary_may_2018.pdf)
...
If we have the ability to model fishing choices at a finer scale than at a trip, this can be modified fairly easily.
