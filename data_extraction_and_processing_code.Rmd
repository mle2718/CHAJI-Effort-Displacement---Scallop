...
PKG <- c("leaflet", "tidyverse", "sf", "ggplot2", "RODM", "ROracle", "dbplyr", "dplyr", "raster","rgdal","readxl")
for (p in PKG) {
...
coordinate_table_input <- readRDS(paste0("C:/Users/marina.chaji/Downloads/VTR_DMIS_AC_Agg",vintage_string,".Rds"))
lat_column = "DDLAT"
lon_column = "DDLON"
