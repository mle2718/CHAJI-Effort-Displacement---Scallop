...
# Set Path
here::i_am("data_extracting_and_processing_code.Rmd")
...
```{r folder_create, include=TRUE, echo=TRUE, results=FALSE}
...
```{r Spatial Joins - Lease Areas and Ten Minute Squares}
...
lease_sp <- st_read("~/All_Lease_Areas_Shapefile")
## Run the below chunk to see your shapefile plotted out
