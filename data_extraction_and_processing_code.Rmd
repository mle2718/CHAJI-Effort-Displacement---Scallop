...
```{r spatial land and water, echo=TRUE}
...
```{r Spatial Join 10 minute squares}
#Step One 
...
TMSQ_sp <- st_read("~/All_Lease_Areas_Shapefile")
## Run the below chunk to see your shapefile plotted out
qtm(TMSQ_sp) + tm_legend(show = FALSE)
...
point_geo <- st_as_sf(final_product, 
                      coords = c(x  = "DDLON", y = "DDLAT"), crs = crs )
final_product_lease <- st_join(point_geo, TMSQ_sp, join = st_within)
