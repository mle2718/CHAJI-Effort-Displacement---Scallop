...
#save to RDS
APSD_DMIS_2 <-paste0("APSD_DMIS_2",".Rds")
...
#save to RDS
RESULT_COMPILED <-paste0("RESULT.COMPILED",".Rds")
saveRDS(RESULT_COMPILED, file=here("data","intermediate",RESULT_COMPILED))
...
#save to RDS
Scallop_Linkingorg <-paste0("Scallop_Linkingorg",".Rds")
...
#save to RDS
all_yrs_costs <-paste0(all_yrs_costs,".Rds")
