...
#save to RDS
RESULT_COMPILED <-paste0("RESULT.COMPILED",vintage_string,".Rds")
saveRDS(RESULT_COMPILED, file=here("data","intermediate",RESULT.COMPILED))
...
#save to RDS
all_yrs_costs <-paste0(file.path(data, intermediate, "all_yrs_costs.Rds"))
