...
# Set Path
here::i_am("data_processing.Rmd")



PKG <- c("here","leaflet", "tidyverse", "sf", "dbplyr","raster","rgdal","readxl", "data.table", "tmaptools", "tmap", "dplyr","RODBC", "RODM","here","readxl")
for (p in PKG) {
...
Scallop_Linkingorg <- readRDS("~/Effort-Displacement---Scallop/data/intermediate/Scallop_Linkingorg.Rds")
RESULT_COMPILED <- readRDS("~/Effort-Displacement---Scallop/data/intermediate/RESULT_COMPILED.Rds")
APSD_DMIS_2 <- readRDS("~/Effort-Displacement---Scallop/data/intermediate/APSD_DMIS_2.Rds")
all_yrs_costs <- readRDS("~/Effort-Displacement---Scallop/data/intermediate/all_yrs_costs.Rds")
