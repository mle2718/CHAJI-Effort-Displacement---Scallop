...
Inside_CA2_GC <- scallop0322MainDataTable_gc_ca2_2023_11_06 %>% filter(in_closure == "TRUE")
...
dropped_values_CA_1_2_LA <- anti_join(Inside_CA1_LA, Inside_CA2_LA, by = "TRIPID")

dropped_values_CA_2_3_LA <- anti_join(Inside_CA2_LA, Inside_CA3_LA, by = "TRIPID")
...
BSDA::z.test(dropped_values_CA_1_2_GC$DOLLAR_2022_win,
  y = Inside_CA2_GC$DOLLAR_2022_win,
  sigma.x = sd(dropped_values_CA_1_2_GC$DOLLAR_2022_win),
  sigma.y = sd(Inside_CA2_GC$DOLLAR_2022_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
...
BSDA::z.test(dropped_values_CA_2_3_GC$DOLLAR_2022_win,
  y = Inside_CA2_GC$DOLLAR_2022_win,
  sigma.x = sd(dropped_values_CA_2_3_GC$DOLLAR_2022_win),
  sigma.y = sd(Inside_CA2_GC$DOLLAR_2022_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
...
```{r}
## Phase 1
BSDA::z.test(dropped_values_CA_1_2_GC$LANDED_win,
  y = Inside_CA2_GC$LANDED_win,
  sigma.x = sd(dropped_values_CA_1_2_GC$LANDED_win),
...
```{r}
# Phase 1 to 2 
BSDA::z.test(dropped_values_CA_1_2_GC$VPUE_win,
  y = Inside_CA2_GC$VPUE_win,
  sigma.x = sd(dropped_values_CA_1_2_GC$VPUE_win),
  sigma.y = sd(Inside_CA2_GC$VPUE_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
...
BSDA::z.test(dropped_values_CA_2_3_GC$VPUE_win,
  y = Inside_CA2_GC$VPUE_win,
  sigma.x = sd(dropped_values_CA_2_3_GC$VPUE_win),
...
BSDA::z.test(dropped_values_CA_1_2_LA$VPUE_win,
  y = Inside_CA2_LA$VPUE_win,
  sigma.x = sd(dropped_values_CA_1_2_LA$VPUE_win),
  sigma.y = sd(Inside_CA2_LA$VPUE_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
...
## Phase 2 to 3
BSDA::z.test(dropped_values_CA_2_3_LA$VPUE_win,
  y = Inside_CA2_LA$VPUE_win,
  sigma.x = sd(dropped_values_CA_2_3_LA$VPUE_win),
  sigma.y = sd(Inside_CA3_LA$VPUE_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
