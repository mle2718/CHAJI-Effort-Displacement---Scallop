...
BSDA::z.test(dropped_values_1_2_AA$DOLLAR_2022_win,
  y = Inside_NY2_AA$DOLLAR_2022_win,
  sigma.x = sd(dropped_values_1_2_AA$DOLLAR_2022_win),
...
BSDA::z.test(dropped_values_1_2_AA$DOLLAR_2022_win,
  y = Inside_NY2_AA2$DOLLAR_2022_win,
  sigma.x = sd(dropped_values_1_2_AA$DOLLAR_2022_win),
  sigma.y = sd(Inside_NY2_AA$DOLLAR_2022_win),
  alternative = c("two.sided"),
  conf.level = 0.99)
...
## Phase 2 to 3
BSDA::z.test(dropped_values_2_3_AA$DOLLAR_2022_win,
  y = Inside_NY2_AA$DOLLAR_2022_win,
  sigma.x = sd(dropped_values_2_3_AA$DOLLAR_2022_win),
  sigma.y = sd(Inside_NY2_AA$DOLLAR_2022_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
...
BSDA::z.test(dropped_values_1_2_DAS$DOLLAR_2022_win,
  y = Inside_NY2_DAS$DOLLAR_2022_win,
  sigma.x = sd(dropped_values_1_2_DAS$DOLLAR_2022_win),
...
BSDA::z.test(dropped_values_1_2_DAS$DOLLAR_2022_win,
  y = Inside_NY2_DAS2$DOLLAR_2022_win,
  sigma.x = sd(dropped_values_1_2_DAS$DOLLAR_2022_win),
  sigma.y = sd(Inside_NY2_DAS$DOLLAR_2022_win),
  alternative = c("two.sided"),
  conf.level = 0.99)
...
## Phase 2 to 3
BSDA::z.test(dropped_values_2_3_DAS$DOLLAR_2022_win,
  y = Inside_NY2_DAS$DOLLAR_2022_win,
  sigma.x = sd(dropped_values_2_3_DAS$DOLLAR_2022_win),
  sigma.y = sd(Inside_NY2_DAS$DOLLAR_2022_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
...
Limited Access Landed z-tests
```{r}

# Access Area 
## Phase 1 to 2

BSDA::z.test(dropped_values_1_2_AA$LANDED_win,
  y = Inside_NY2_AA$LANDED_win,
  sigma.x = sd(dropped_values_1_2_AA$LANDED_win),
...
## Phase 2 to 3
BSDA::z.test(dropped_values_2_3_AA$LANDED_win,
  y = Inside_NY2_AA$LANDED_win,
  sigma.x = sd(dropped_values_2_3_AA$LANDED_win),
  sigma.y = sd(Inside_NY2_AA$LANDED_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
...
BSDA::z.test(dropped_values_1_2_DAS$LANDED_win,
  y = Inside_NY2_DAS$LANDED_win,
  sigma.x = sd(dropped_values_1_2_DAS$LANDED_win),
...
## Phase 2 to 3
BSDA::z.test(dropped_values_2_3_DAS$LANDED_win,
  y = Inside_NY2_DAS$LANDED_win,
  sigma.x = sd(dropped_values_2_3_DAS$LANDED_win),
  sigma.y = sd(Inside_NY2_DAS$LANDED_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
...
Limited Access Z-test Operating Profit 
```{r}

# Access Area 
## Phase 1 to 2

BSDA::z.test(dropped_values_1_2_AA$OPERATING_PROFIT_2022_win,
  y = Inside_NY2_AA$OPERATING_PROFIT_2022_win,
  sigma.x = sd(dropped_values_1_2_AA$OPERATING_PROFIT_2022_win),
...
BSDA::z.test(dropped_values_1_2_AA$OPERATING_PROFIT_2022_win,
  y = Inside_NY2_AA2$OPERATING_PROFIT_2022_win,
  sigma.x = sd(dropped_values_1_2_AA$OPERATING_PROFIT_2022_win),
  sigma.y = sd(Inside_NY2_AA$OPERATING_PROFIT_2022_win),
  alternative = c("two.sided"),
  conf.level = 0.99)
...
## Phase 2 to 3
BSDA::z.test(dropped_values_2_3_AA$OPERATING_PROFIT_2022_win,
  y = Inside_NY2_AA$OPERATING_PROFIT_2022_win,
  sigma.x = sd(dropped_values_2_3_AA$OPERATING_PROFIT_2022_win),
  sigma.y = sd(Inside_NY2_AA$OPERATING_PROFIT_2022_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
...
BSDA::z.test(dropped_values_1_2_DAS$OPERATING_PROFIT_2022_win,
  y = Inside_NY2_DAS$OPERATING_PROFIT_2022_win,
  sigma.x = sd(dropped_values_1_2_DAS$OPERATING_PROFIT_2022_win),
...
BSDA::z.test(dropped_values_1_2_DAS$OPERATING_PROFIT_2022_win,
  y = Inside_NY2_DAS2$OPERATING_PROFIT_2022_win,
  sigma.x = sd(dropped_values_1_2_DAS$OPERATING_PROFIT_2022_win),
  sigma.y = sd(Inside_NY2_DAS$OPERATING_PROFIT_2022_win),
  alternative = c("two.sided"),
  conf.level = 0.99)
...
## Phase 2 to 3
BSDA::z.test(dropped_values_2_3_DAS$OPERATING_PROFIT_2022_win,
  y = Inside_NY2_DAS$OPERATING_PROFIT_2022_win,
  sigma.x = sd(dropped_values_2_3_DAS$OPERATING_PROFIT_2022_win),
  sigma.y = sd(Inside_NY2_DAS$OPERATING_PROFIT_2022_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
...
Limited Access Z-test VPUE
```{r}

# Access Area 
## Phase 1 to 2

BSDA::z.test(dropped_values_1_2_AA$VPUE_win,
  y = Inside_NY2_AA$VPUE_win,
  sigma.x = sd(dropped_values_1_2_AA$VPUE_win),
...
## Phase 2 to 3
BSDA::z.test(dropped_values_2_3_AA$VPUE_win,
  y = Inside_NY2_AA$VPUE_win,
  sigma.x = sd(dropped_values_2_3_AA$VPUE_win),
  sigma.y = sd(Inside_NY2_AA$VPUE_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
...
BSDA::z.test(dropped_values_1_2_DAS$VPUE_win,
  y = Inside_NY2_DAS$VPUE_win,
  sigma.x = sd(dropped_values_1_2_DAS$VPUE_win),
...
## Phase 2 to 3
BSDA::z.test(dropped_values_2_3_DAS$VPUE_win,
  y = Inside_NY2_DAS$VPUE_win,
  sigma.x = sd(dropped_values_2_3_DAS$VPUE_win),
  sigma.y = sd(Inside_NY2_DAS$VPUE_win),
  alternative = c("two.sided"),
  conf.level = 0.90)
