...
You are sitting in  `r params$AA_DAS_only`. The value of AA_DAS is `r params$AA_DAS_only`.  The value of subtrip_aggregate is `r params$subtrip_aggregate`.  The value of  BIN_GEARS is `r params$BIN_GEARS`.  The input shapefile has been set to   `r params$input_shapefile`.
...
```{r eval=AA_DAS_param_hack, echo=params$AA_DAS_only}
zone_out <- 
