...
params:
    ...
    input_shapefile:
      ...
      choices: ["wind_sf_final.RDS","wind_sf_nocable.RDS","wind_NY1.RDS","wind_NY2.RDS","wind_Central_Atlantic_1.RDS", "wind_Central_Atlantic_2.RDS"]
...
The value of AA_DAS is `r params$AA_DAS_only`.  The value of subtrip_aggregate is `r params$subtrip_aggregate`.  The value of  BIN_GEARS is `r params$BIN_GEARS`.  The input shapefile has been set to   `r params$input_shapefile`.
