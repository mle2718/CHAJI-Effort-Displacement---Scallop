...
params$subset will govern whether the data are subset.  You can get 
1. Limited Access Fleet only, when fleet_type=AA_DAS_only.
2. General Category IFQ fleet only, when fleet_type==GCIFQ
