...
```{r}
scallop0322MainDataTable %>% 
  summarize(across(.cols = c("DOLLAR_2022", "DOLLAR_ALL_SP_2022","LANDED", "TRIP_LENGTH"), 
...
boxplot(scallop0322MainDataTable$LANDED,
  main = "Catch in Pounds",
  xlab = "Pounds",
  ylab = "Catch",
  col = "white",
  border = "black",
...
<br><br><br>
Observations inside/outside closures by year and fleet. This does not work, but I'm leaving it here because some of the fishset functions may be "group" aware.
```{r, eval=FALSE}
