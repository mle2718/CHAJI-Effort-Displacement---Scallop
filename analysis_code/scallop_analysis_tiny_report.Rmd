...
# This creates outputs for Figure 2,  Offshore Wind Lease Areas approved within federal waters of the Northeast region of the United States, in the scallop methods paper.  
...
# creates outputs for bar graph used in Figure 2, Offshore Wind Lease Areas approved within federal waters of the Northeast region of the United States, in the scallop methods paper.
...
```{r}
table_convert <- c("wind_NY1.RDS","wind_NY2.RDS","wind_NY3.RDS","wind_sf_nocable_agg.RDS","wind_sf_nocable.RDS", "wind_Central_Atlantic_3.RDS","wind_Central_Atlantic_2.RDS","wind_Central_Atlantic_1.RDS")
...
Z-tests comparing average revenue of trips inside and outside of potential offshore wind development areas / closures
...
Section 4.1 Scallop fishing in the Wind Lease Areas in the Northeast U.S. - and Section 5 Discussion and Conclusions - "Over the 15-year study period, 7% (6,602) of the GC-IFQ fleet trips occurred within Lease Areas; these trips accounted for approximately ~7% (38M) of the GC-IFQ fleet’s scallop revenue and 7% ($29M) of operating profit."
...
Total/Aggregate Operating Profit by closure area.
```{r}
zone_out <- 
zone_summary(scallop0322MainDataTable, project = project,
         spat = scallop0322WindCloseSpatTable,
...
Shapefile: Wind_sf_combined - Section 4.1 Scallop fishing in the Wind Lease Areas in the Northeast U.S. - Code chunk below creates Table 2. GC-IFQ Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day.; Table 3. Limited Access (Access Area) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day.; Table 4. Limited Access (DAS) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day.**(Number of Observations)**

Shapefile: wind_NYx - Section 4.2 The Adaptive Wind Development Processes -  New York Bight - Code chunk below creates Table 5. GC-IFQ Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for the New York Bight region.; Table 6. Limited Access (DAS) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for New York Bight.; Table 7. Limited Access (Access Area) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for New York Bight. **(Number of Observations)**

Shapefile: wind_CAx - Section 4.2 The Adaptive Wind Development Processes -  Central Atlantic - Code chunk below creates Table 8. GC-IFQ Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for the Central Atlantic region.; Table 9. Limited Access (AA) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for the Central Atlantic region.; Table 10. Limited Access (DAS) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for the Central Atlantic region. **(Number of Observations)**


Shapefile: Wind_sf_combined - Section 4.1 Scallop fishing in the Wind Lease Areas in the Northeast U.S. - "Over the 15-year study period, 7% (6,602) of the GC-IFQ fleet trips occurred within Lease Areas; these trips accounted for approximately ~7% (38M) of the GC-IFQ fleet’s scallop revenue and 7% ($29M) of operating profit."**(Number of Observations)**


Shapefile: wind_NY1 - Section 4.2 The Adaptive Wind Development Processes - New York Bight - "Within the New York Bight Call Area, scallop fishing has occurred to a relatively large extent; 23,655 trips in the LA and GC-IFQ fleets took place during fishing years 2007-2021. These trips were primarily from the GC-IFQ fleet. Nearly 20% (19,781) of all trips taken by the GC-IFQ fleet were inside the New York Bight Call Area, a relatively inshore location accessible to smaller fishing vessels. "**(Number of Observations)**


Shapefile: wind_NY2 and wind_NY3 - Section 4.2 The Adaptive Wind Development Processes - New York Bight - "LA-DAS trips were most disproportionate at aggregate levels between the Wind Energy Area and Lease Area phases where operating profit and scallop revenue were disproportionately smaller (~25%). The LA-DAS metier had the highest total operating profit and scallop revenues despite accounting for only 16% of total trips in New York Bight Call Areas."**(Number of Observations)**

Shapefile: wind_CA1 and wind_CA2 - Section 4.2 The Adaptive Wind Development Processes - Central Atlantic - “In the Central Atlantic region, The GC-IFQ fleet performed more trips than the LA fleet; The number of trips taken by the GC-IFQ fleet ultimately decreased by almost 57% from Call Area to Wind Energy Area, significantly less than the reduction in land size considered for development.“ and "The number of impacted trips significantly decreased (~97%) between phases of this metier." and Section 5 Discussion and Conclusions - "The GC-IFQ fleet, with a higher trip frequency in the Central Atlantic compared to the LA fleet, underwent a nearly 57% reduction in trips from the Call Area to the Final Wind Energy Area."**(Number of Observations)**

Shapefile: wind_CA1 and wind_CA2 - Section Appendix A. - The Adaptive Wind Development Processes - Central Atlantic - "The fleet experienced a 94% reduction in trips from Call Area to Final Wind Energy Area; but yields higher revenues, landed, profits, and revenue per day on average across each trip compared to the GC-IFQ fleet." and Section 5 Discussion and Conclusions 5 - "The LA fleet experienced a profound 94% reduction in trips from the Call Area to the Final Wind Energy Area, with statistically significant impacts on average revenue, landed, profits, and revenue per day observed at each wind development stage."**(Number of Observations)**
...
## Aggregate Revenue Winsorized

**Aggregate Revenue Winsorized by closure area.**

Shapefile: Wind_sf_combined - Section 4.1 Scallop fishing in the Wind Lease Areas in the Northeast U.S. - and Section 5. - Discussion and Conclusions - “Over the 15-year study period, 3% (1,447) of the LA trips occurred within Lease Areas (Figure 5); these trips accounted for approximately 4% (279M) of LA fleet scallop revenue and 3% (259M) of operating profit.”

Shapefile: wind_NY1 and wind_NY2 - Section 4.2 The Adaptive Wind Development Processes - New York Bight - "Aggregate operating profit and scallop revenue between the Call Area and Wind Energy Area phases are found to have disproportionately large (~61%), relative to the reduction size of the wind development areas."

Shapefile: wind_NY2 and wind_NY3 - Section 4.2 The Adaptive Wind Development Processes - New York Bight -"LA-DAS trips were most disproportionate at aggregate levels between the Wind Energy Area and Lease Area phases where operating profit and scallop revenue were disproportionately smaller (~25%). The LA-DAS metier had the highest total operating profit and scallop revenues despite accounting for only 16% of total trips in New York Bight Call Areas."

Shapefile: wind_CA1 and wind_CA2 - Section 4.2 The Adaptive Wind Development Processes - Central Atlantic - "At aggregate levels, operating profit and scallop revenues were significantly smaller (~66%) than the reduction size of the potential wind development areas. Impacted footprint was also drastically disproportionate with only a 61% reduction in trips."  
...
## Average Revenue Winsorized

**Average Winsorized Revenue in closures by fleet**

Shapefile: Wind_sf_combined - Section 4.1 Scallop fishing in the Wind Lease Areas in the Northeast U.S. - Code chunk below creates outputs for Table 2. GC-IFQ Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day.; Table 3. Limited Access (Access Area) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day.; Table 4. Limited Access (DAS) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day. **(Average Winsorized Revenue in closures by fleet)**

Shapefile: wind_NYx - Section 4.2 The Adaptive Wind Development Processes  New York Bight - Code chunk below creates outputs for Table 5. GC-IFQ Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for the New York Bight region.; Table 6. Limited Access (DAS) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for New York Bight.; Table 7. Limited Access (Access Area) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for New York Bight.**(Average Winsorized Revenue in closures by fleet)**

Shapefile: wind_CAx - Section 4.2 The Adaptive Wind Development Processes  Central Atlantic - Code chunk below creates outputs for Table 8. GC-IFQ Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for the Central Atlantic region.; Table 9. Limited Access (AA) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for the Central Atlantic region.; Table 10. Limited Access (DAS) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day for the Central Atlantic region.**(Average Winsorized Revenue in closures by fleet)**


Shapefile: Wind_sf_combined - Section 4.1 - Scallop fishing in the Wind Lease Areas in the Northeast U.S. - "Mean scallop revenues and landings from trips inside the Lease Areas are slightly higher than outside the Lease Areas at conventional significance levels (Table 3)."**(Average Winsorized Revenue in closures by fleet)**

Shapefile: Wind_sf_combined - Section 4.1 - Scallop fishing in the Wind Lease Areas in the Northeast U.S. - "In general, AA trips inside the Lease areas are slightly worse than trips outside the lease areas: mean values of revenue, landed pounds, and revenue per day are lower inside the Lease Areas than outside at conventional significance levels."**(Average Winsorized Revenue in closures by fleet)**
...
## Percent of Revenue Winsorized 
**Percent of Scallop winsorized revenue by closure area.**

Section 4.1 Scallop fishing in the Wind Lease Areas in the Northeast U.S. - and Section 5 Discussion and Conclusions - "Over the 15-year study period, 7% (6,602) of the GC-IFQ fleet trips occurred within Lease Areas; these trips accounted for approximately ~7% (38M) of the GC-IFQ fleet’s scallop revenue and 7% ($29M) of operating profit." *(Percent of winsorized revenue)**
...
Section 4.1 Scallop fishing in the Wind Lease Areas in the Northeast U.S. - "Over the 15-year study period, 7% (6,602) of the GC-IFQ fleet trips occurred within Lease Areas; these trips accounted for approximately ~7% (38M) of the GC-IFQ fleet’s scallop revenue and 7% ($29M) of operating profit." **(Percent of Scallop winsorized profit)**
