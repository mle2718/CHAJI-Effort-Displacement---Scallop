...
params:
  ...
  location:
    ...
    - Seattle
  input_shapefile:
    value: wind_Central_Atlantic_1.RDS
    choices:
    - wind_NY1.RDS
    - wind_NY2.RDS
    - wind_NY3.RDS
...
Here is DOLLAR, KILOGRAMS, CREW, LANDED, DOLLAR, OPERATING PROFIT and TRIP_LENGTH separately. 
```{r}
scallop0322MainDataTable %>% 
  summarize(across(.cols = c("LANDED_KG","LANDED", "DOLLAR_2022" , "OPERATING_PROFIT_2022","TRIP_LENGTH"), 
                   .fns = list(min = min, median = median, mean = mean, max = max, StdDev = sd ,sum=sum, Q25 = ~quantile(.,0.25,na.rm=TRUE), Q50 = ~quantile(.,0.50,na.rm=TRUE), Q75 = ~quantile(.,0.75,na.rm=TRUE), Q95 = ~quantile(.,0.95,na.rm=TRUE),
...
<br><br><br>
Average Revenue by top 10 ports. 
```{r}
cpue_out <- 
  species_catch(scallop0322MainDataTable, project,
                species = "DOLLAR_2022",
...
```{r}
table_convert <- c("wind_NY1.RDS","wind_NY2.RDS","wind_NY3.RDS","wind_sf_nocable_agg.RDS","wind_sf_nocable.RDS")
...
```
<br><br><br>
Box Plots of Revenues in and outside of closures
```{r}
...
# Winsorize Data
out_closure_scallop0322MainDataTable$DOLLAR_2022_win<- datawizard::winsorize(out_closure_scallop0322MainDataTable$DOLLAR_2022, threshold = 0.1)

in_closure_scallop0322MainDataTable$DOLLAR_2022_win<- datawizard::winsorize(in_closure_scallop0322MainDataTable$DOLLAR_2022, threshold = 0.1)
...
<br><br><br>
Box Plots of Landed in and outside of closures
```{r}
# To perform the t-tests and make boxplots, observations are separated into two separate samples, inside and outside of closures
...
# Winsorize Data
out_closure_scallop0322MainDataTable$LANDED_win<- datawizard::winsorize(out_closure_scallop0322MainDataTable$LANDED, threshold = 0.1)

in_closure_scallop0322MainDataTable$LANDED_win<- datawizard::winsorize(in_closure_scallop0322MainDataTable$LANDED, threshold = 0.1)
...
<br><br><br>
Average Revenue in closures by port
```{r}
zone_out <- 
zone_summary(scallop0322MainDataTable, project = project,
         spat = scallop0322WindCloseSpatTable,
...
```
<br><br><br>
Average Revenue by top 10 ports, fleet, and closure
```{r}
cpue_out <- 
  species_catch(scallop0322MainDataTable, project,
                species = "DOLLAR_2022",
...
```
<br><br><br>
Box Plots of Operating Profits in and outside of closures
```{r}
# To perform the t-tests and make boxplots, observations are separated into two separate samples, inside and outside of closures
in_closure_scallop0322MainDataTable <- scallop0322MainDataTable %>% filter(in_closure == "TRUE")
out_closure_scallop0322MainDataTable <- scallop0322MainDataTable %>% filter(in_closure == "FALSE")
...
# Winsorize Data
out_closure_scallop0322MainDataTable$OPERATING_PROFIT_2022_win<- datawizard::winsorize(out_closure_scallop0322MainDataTable$OPERATING_PROFIT_2022, threshold = 0.1)

in_closure_scallop0322MainDataTable$OPERATING_PROFIT_2022_win<- datawizard::winsorize(in_closure_scallop0322MainDataTable$OPERATING_PROFIT_2022, threshold = 0.1)
...
<br><br><br>
Average Operating Profit in closures by port
```{r}
zone_out <- 
zone_summary(scallop0322MainDataTable, project = project,
         spat = scallop0322WindCloseSpatTable,
...
<br><br><br>
Average Operating Profit in closures by fleet
```{r}
zone_out <- 
zone_summary(scallop0322MainDataTable, project = project,
         spat = scallop0322WindCloseSpatTable,
...
<br><br><br>
Average Operating Profit by top 10 ports, fleet, and closure
```{r}
cpue_out <- 
  species_catch(scallop0322MainDataTable, project,
                species = "OPERATING_PROFIT_2022",
...
```
<br><br><br>
Box Plots of VPUE in and outside of closures
```{r}
# To perform the t-tests and make boxplots, observations are separated into two separate samples, inside and outside of closures
...
# Winsorize Data
out_closure_scallop0322MainDataTable$VPUE_win<- datawizard::winsorize(out_closure_scallop0322MainDataTable$VPUE, threshold = 0.1)

in_closure_scallop0322MainDataTable$VPUE_win<- datawizard::winsorize(in_closure_scallop0322MainDataTable$VPUE, threshold = 0.1)
...
<br><br><br>
Average VPUE by top 10 ports, fleet, and closure
```{r}
cpue_out <- 
  species_catch(scallop0322MainDataTable, project,
                species = "VPUE",
