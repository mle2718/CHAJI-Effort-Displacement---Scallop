...
This chunk is used to create Table 2, Table 3, and Table 4 using the following shapefile: Wind_sf_combined 
...
# Z-test of Winsorized VPUE comparing trips inside and outside of assigned potential lease development areas / closures
