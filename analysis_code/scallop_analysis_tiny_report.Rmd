...
Tables 3, 4, and 5, Scallop fishing in the Wind Lease Areas in the Northeast U.S., are created using tables from the **scallop_analysis_tiny_report.Rmd**. 
...
**Table 3. GC-IFQ Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day.** 
input shapefile
    value wind_sf_combined.RDS
AA_DAS_only FALSE

**Table 4.  Limited Access (Access Area) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day and Table 5.  Limited Access (DAS) Scallop trips, average scallop revenue, average landings, average operating profit, and average revenue per day.**
...
Number of observations.
This chunk is used to create Table 3, Table 4, and Table 5.
```{r}
