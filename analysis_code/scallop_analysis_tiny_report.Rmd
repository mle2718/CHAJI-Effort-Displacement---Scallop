...
if (params$AA_DAS_only==TRUE){
  ...
  t.test(in_closure_scallop0322MainDataTable_AA$VPUE,y=out_closure_scallop0322MainDataTable_AA$VPUE, alternative=c("two.sided"), paired=FALSE, var.equal=FALSE, conf.level=0.99)
...
if (params$AA_DAS_only==TRUE){
    ...
    t.test(in_closure_scallop0322MainDataTable_DAS$VPUE,y=out_closure_scallop0322MainDataTable_DAS$VPUE, alternative=c("two.sided"), paired=FALSE, var.equal=FALSE, conf.level=0.99)
...
if (params$AA_DAS_only==TRUE){
      ...
      t.test(in_closure_scallop0322MainDataTable_AA$VPUE_win,y=out_closure_scallop0322MainDataTable_AA$VPUE_win, alternative=c("two.sided"), paired=FALSE, var.equal=FALSE, conf.level=0.99)
...
# DAS Trip Type - Winsorized
if (params$AA_DAS_only==TRUE){
        t.test(in_closure_scallop0322MainDataTable_DAS$VPUE_win,y=out_closure_scallop0322MainDataTable_DAS$VPUE_win, alternative=c("two.sided"), paired=FALSE, var.equal=FALSE, conf.level=0.99)
