...
params:
    ...
    input_shapefile:
      value: "wind_NY1.RDS"
      choices: ["wind_NY1.RDS","wind_NY2.RDS","wind_NY3.RDS","wind_Central_Atlantic_1.RDS", "wind_Central_Atlantic_2.RDS","wind_sf_final.RDS","wind_sf_nocable.RDS"]
---
<!---
YAML options: 
...
```{r}
table_convert <- c("wind_NY1.RDS","wind_NY2.RDS","wind_NY3.RDS","wind_Central_Atlantic_1.RDS", "wind_Central_Atlantic_2.RDS","wind_sf_final.RDS","wind_sf_nocable.RDS")
out_switch <- ifelse(params$input_shapefile %in% table_convert, "tab_plot")
