...
rds_savename<-paste0("scallop0322MainDataTable_",vintage_string,".Rds")	
csv_savename<-paste0("scallop0322MainDataTable_",vintage_string,".csv")	
saveRDS(scallop0322MainDataTable, file=here("data","main",rds_savename))	
write.csv(scallop0322MainDataTable,file=here("data","main",csv_savename), row.names = FALSE)	
