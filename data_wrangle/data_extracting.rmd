...
APSD_DMIS_2 <- tbl(con, sql("select TO_CHAR(DATE_TRIP, 'MM/DD/YY HH24:MI:SS ') AS DATE_TRIP, VTR_PORT
                            VTR_STATE, TRIP_LENGTH, PERMIT, DEALER_RPT_ID, DOLLAR, POUNDS, LANDED, DDLON, DDLAT, DOCID,
                            GEARCODE, SECGEARFISH, NESPP3, SOURCE, DEALNUM from APSD.DMIS_WIND_111522@garfo_nefsc")) %>% collect()
dbDisconnect(con)
