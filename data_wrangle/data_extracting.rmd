...
| Column  | Description           |
|------------|:-----------------------------------------------|
|TRIP_COST_2020_DOL|Trip costs, in 2020 (US GDP Implicit price deflator) dollars|
|TRIP_COST_WINSOR_2020_DOL|Trip costs, in 2020 (US GDP Implicit price deflator) dollars|
"
cat(tabl) 
```
...
```{r DRC_fix_APSD_DMIS_2, echo=TRUE, results=FALSE,eval=extract_switch}
...
```{r readin_spacepanels, echo=TRUE,eval=extract_switch}
#Import Data
...
```{r VTR_Query, echo=TRUE, results=FALSE,eval=extract_switch}
...
```{r DMIS_Query, echo=TRUE,eval=extract_switch}
...
```{r merge_cost_data, echo=TRUE, eval=extract_switch}
#Import Data
