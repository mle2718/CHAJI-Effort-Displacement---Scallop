...
cost_directory2<-file.path(socialsci_dir,"Trip_Costs","2010-2021")
...
Scallops$scallop_fishing_year[Scallops$Date >= "2023-04-01" & Scallops$Date <= "2023-03-31"] <- "2023"
...
if(DMIS_type=="frozen_GARFO"){
  ...
  filter(YEAR <= "2019")
    ...
    VTR_DMIS_merge <- VTR_DMIS_merge %>%
  filter(scallop_fishing_year <= "2019")
}
