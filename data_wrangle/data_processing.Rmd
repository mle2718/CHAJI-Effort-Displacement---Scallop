...
Scallops$scallop_fishing_year[Scallops$Date >= "2006-03-01" & Scallops$Date <= "2007-02-29"] <- "2007"
Scallops$scallop_fishing_year[Scallops$Date >= "2007-03-01" & Scallops$Date <= "2008-02-29"] <- "2008"
Scallops$scallop_fishing_year[Scallops$Date >= "2008-03-01" & Scallops$Date <= "2009-02-29"] <- "2009"
Scallops$scallop_fishing_year[Scallops$Date >= "2009-03-01" & Scallops$Date <= "2010-02-29"] <- "2010"
Scallops$scallop_fishing_year[Scallops$Date >= "2010-03-01" & Scallops$Date <= "2011-02-29"] <- "2011"
Scallops$scallop_fishing_year[Scallops$Date >= "2011-03-01" & Scallops$Date <= "2012-02-29"] <- "2012"
Scallops$scallop_fishing_year[Scallops$Date >= "2012-03-01" & Scallops$Date <= "2013-02-29"] <- "2013"
Scallops$scallop_fishing_year[Scallops$Date >= "2013-03-01" & Scallops$Date <= "2014-02-29"] <- "2014"
Scallops$scallop_fishing_year[Scallops$Date >= "2014-03-01" & Scallops$Date <= "2015-02-29"] <- "2015"
Scallops$scallop_fishing_year[Scallops$Date >= "2015-03-01" & Scallops$Date <= "2016-02-29"] <- "2016"

#The scallop fishing year in 2017 was from March 1st to March 31st
Scallops$scallop_fishing_year[Scallops$Date >= "2016-03-01" & Scallops$Date <= "2017-03-31"] <- "2017"

#The scallop fishing years from 2018 onward are from April 1st to March 31st
Scallops$scallop_fishing_year[Scallops$Date >= "2017-04-01" & Scallops$Date <= "2018-03-31"] <- "2018"
Scallops$scallop_fishing_year[Scallops$Date >= "2018-04-01" & Scallops$Date <= "2019-03-31"] <- "2019"
Scallops$scallop_fishing_year[Scallops$Date >= "2019-04-01" & Scallops$Date <= "2020-03-31"] <- "2020"
Scallops$scallop_fishing_year[Scallops$Date >= "2020-04-01" & Scallops$Date <= "2021-03-31"] <- "2021"
Scallops$scallop_fishing_year[Scallops$Date >= "2021-04-01" & Scallops$Date <= "2022-03-31"] <- "2022"
Scallops$scallop_fishing_year[Scallops$Date >= "2022-04-01" & Scallops$Date <= "2023-03-31"] <- "2023"
