...
# api_key string must be retrieved 
# To use fredr and the FRED API in general, you must first obtain a FRED API key. You can get this from https://research.stlouisfed.org/useraccount/apikey. After you obtain your API key you should then save it in your .Renviron file. Once you have your file open you can save it as the following with no spaces: FRED _ API _ KEY="your_key_here"


# Pull in data 
# GDP Implicit Price Deflator in United States (USAGDPDEFAISMEI); Units:  Index 2015=100, Not Seasonally Adjusted; Frequency:  Annual
...
testing_1 <- testing %>% separate(date, into = c('year','month','day', sep = '-'))
testing_1 <- testing_1[,c("year","value")]




#Test out formula here- just for marina 
# Take Subset of Final Lease Data Set 

test_set <- final_product_lease[,c("TRIPID","DOLLAR_ALL_SP","DOLLAR","TRIP_COST_WINSOR_2020_DOL", "YEAR")]

# Merge Lease Data and Deflator Values 
test_set <- merge(test_set,testing_1, by.x = "YEAR", by.y = "year", all.x = TRUE, all.y = FALSE)

# Use GDP Implicit Price Deflator to convert Nominal Revenue Dollars to 2020 Real Dollars 
test_set$DOLLAR_ALL_SP_2020 <-((test_set$DOLLAR_ALL_SP/test_set$value)*100)   


# Calculate operating profit by subtracting winsor 2020 costs from 2020 all species revenue dollars 
## Note: TRIP_COST_WINSOR_2020_DOL is the cost of a trip and DOLLAR_ALL_SP_2020 will be revenue for the subtrip
test_set$OPERATING_PROFIT_2020 <-(test_set$DOLLAR_ALL_SP_2020-test_set$TRIP_COST_WINSOR_2020_DOL)
