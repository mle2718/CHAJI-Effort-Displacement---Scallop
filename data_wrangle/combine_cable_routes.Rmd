...
wind_sf$LEASE_NUMB <- "NY Bight WEA"
...
wind_NY_area_differences$change <- ((wind_NY_area_differences$area_calc/lag(wind_NY_area_differences$area_calc) - 1) * 100)
...
saveRDS(wind_sf,file=file.path(lease_dirpath,"wind_sf_combined.RDS")) 
