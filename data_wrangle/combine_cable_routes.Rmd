...
wind_NY1 <- sf::st_read(dsn = here::here("data", "external", "shapefiles", "NY Bight Nov 22 Lease Areas","NY Bight Wind Energy Area 2021.shp" ))
wind_NY2 <- sf::st_read(dsn = here::here("data", "external", "shapefiles", "NY Bight Nov 22 Lease Areas","NY Bight Lease Areas pulled Nov 2022.shp" ))
...
wind_Central_Atlantic_1 <- prep_spat(wind_Central_Atlantic_2)
