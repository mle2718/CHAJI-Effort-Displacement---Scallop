...
# wind_NY1 <- sf::st_read(dsn = here::here("data", "external", "shapefiles", folder))
# wind_NY2 <- sf::st_read(dsn = here::here("data", "external", "shapefiles", folder))
# wind_Central_Atlantic_1 <- sf::st_read(dsn = here::here("data", "external", "shapefiles", folder))
# wind_Central_Atlantic_2 <- sf::st_read(dsn = here::here("data", "external", "shapefiles", folder))
